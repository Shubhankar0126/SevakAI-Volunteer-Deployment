...
import { incidentApi } from "@/lib/api/services/sevakai";
...
function SosPage() {
  ...
  const mutation = useMutation({
    mutationFn: (kind: "critical" | "medical" | "crowd") => incidentApi.triggerSos(kind),
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              One tap broadcasts your location to the nearest zone manager.
            </p>
          </div>
        </div>
        <Button
          onClick={() => mutation.mutate("critical")}
      ...
      <div className="mt-6 grid gap-3 md:grid-cols-2">
        <button
          onClick={() => mutation.mutate("medical")}
