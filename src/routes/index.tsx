    ...
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-8 text-sm font-medium md:flex">
          ...
          <a href="#command" className="text-muted-foreground hover:text-foreground transition">
            Command Center
          </a>
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-6 pb-24 pt-20 lg:grid-cols-[1.1fr_0.9fr] lg:pb-32 lg:pt-28">
        <div className="text-primary-foreground">
          <div className="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/10 px-3 py-1 text-xs font-medium text-gold backdrop-blur">
            ...
            AI Command Center · Built for national-scale events and designed for scalable
            deployment.
          </div>
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-primary-foreground/75">
            ...
            prediction, and shortage forecasting across every ghat, camp, and zone of Mahakumbh
            2028.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Button
              asChild
              size="lg"
              className="bg-gradient-gold text-gold-foreground hover:opacity-95 shadow-gold"
            >
      ...
      <div className="relative rounded-2xl border border-primary-foreground/15 bg-sidebar/80 p-5 shadow-elegant backdrop-blur">
        ...
        <div className="mt-5 space-y-2">
          ...
          {incidents.map((i) => (
            <div
              key={i.tag}
              className="flex items-center justify-between rounded-lg border border-primary-foreground/10 bg-primary-foreground/4 px-3 py-2.5"
            >
    ...
    <section id="command" className="bg-sidebar text-sidebar-foreground">
      <div className="mx-auto max-w-7xl px-6 py-24">
        <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            <div className="text-sm font-medium uppercase tracking-wider text-gold">
              Command Center
            </div>
          ...
          <div className="rounded-2xl border border-sidebar-border bg-sidebar/40 p-2 shadow-elegant">
            <div className="rounded-xl border border-sidebar-border bg-background p-5 text-foreground">
              <div className="flex items-center justify-between border-b border-border pb-3">
                ...
                <div className="rounded-full bg-success/15 px-2.5 py-0.5 text-xs font-medium text-success">
                  Healthy
                </div>
              </div>
                ...
                {Array.from({ length: 35 }).map((_, i) => {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        background: `oklch(${0.95 - intensity * 0.55} ${0.04 + intensity * 0.1} 160)`,
                      }}
                    />
                  );
                })}
